# Create Strategy Tables - SQL Commands

Run these SQL commands in your Supabase SQL Editor to create the new strategy-first tables.
...
After running the above SQL, run this query to verify everything was created:
...
2. 2 strategy configurations (DCA and SWING) inserted
3. The performance view created (will be empty initially)

## Next Steps

After creating these tables, we'll:
1. Create the strategy detection modules
2. Update the ML trainer to use strategy labels
3. Create the DCA and Swing strategy implementations
