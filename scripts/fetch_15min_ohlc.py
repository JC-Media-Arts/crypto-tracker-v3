...
class FifteenMinuteFetcher:
    ...
    def __init__(self):
        ...
        self.symbols = [
            'BTC', 'ETH', 'SOL', 'XRP', 'ADA', 'AVAX', 'DOGE', 'TRX', 'DOT',
            'MATIC', 'LINK', 'UNI', 'LTC', 'BCH', 'ICP', 'ATOM', 'ETC',
            'XLM', 'IMX', 'HBAR', 'VET', 'THETA', 'EOS', 'FTM', 'ALGO', 'AAVE',
            'SAND', 'MANA', 'AXS', 'CRV', 'GALA', 'CHZ', 'ZEC', 'MKR', 'ENJ',
            'COMP', 'SNX', 'BAT', 'ANKR', 'YFI', 'AUDIO'
        ]
