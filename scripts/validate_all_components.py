...
class SystemValidator:
    ...
    async def test_retraining_pipeline(self) -> bool:
        ...
        try:
            ...
            scripts = ["scripts/run_ml_trainer.py", "scripts/railway_retrainer.py", "scripts/schedule_retraining.py"]
    ...
    async def test_position_sizing(self) -> bool:
        ...
        try:
            ...
            size, details = sizer.calculate_position_size(
                symbol="BTC", portfolio_value=10000, market_data=market_data, ml_confidence=0.75
            )
    ...
    async def test_extreme_prices(self) -> bool:
        ...
        try:
            ...
            market_data = {"price": 50000, "volume": 1000000, "volatility": 0.5}  # 50% volatility
