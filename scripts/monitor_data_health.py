...
class DataHealthMonitor:
    ...
    def check_pipeline_status(self) -> Dict:
        ...
        try:
            ...
            response = self.supabase.client.table('pipeline_runs').select(
                '*'
            ).gte(
                'started_at', since
            ).order(
    ...
    def check_gap_status(self) -> Dict:
        ...
        try:
            ...
            response = self.supabase.client.table('data_gaps').select(
                '*'
            ).eq(
                'healed', False
            ).gte(
...
def main():
    ...
    parser.add_argument('--check', choices=['freshness', 'quality', 'pipeline', 'gaps', 'all'],
