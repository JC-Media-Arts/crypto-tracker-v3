...
class ChannelModelTrainer:
    ...
    def prepare_features(self, df: pd.DataFrame) -> tuple:
        ...
        return X, y_binary, np.array(y_optimal_tp), np.array(y_optimal_sl), np.array(y_hold_time)
    ...
    def train_models(self, X, y_binary, y_tp, y_sl, y_hold):
        ...
        y_tp_train, y_tp_test, y_sl_train, y_sl_test, \
        y_hold_train, y_hold_test = train_test_split(
            X, y_binary, y_tp, y_sl, y_hold, 
        ...
        # Feature importance
        feature_names = [
            'range_width', 'position_in_range', 'resistance_touches',
            'support_touches', 'total_touches', 'volatility',
            'volume_trend', 'risk_reward'
        ]
