...
class KrakenPaperTradingTest:
    ...
    def __init__(self):
        ...
        self.trading_pairs = ["BTC-USD", "ETH-USD", "SOL-USD", "MATIC-USD", "DOGE-USD"]
    ...
    async def test_swing_strategy(self):
        ...
        for scenario in test_scenarios:
            ...
            should_swing = (
                scenario["price_change_24h"] > 3.0
                and scenario["volume_ratio"] > 2.0
                and scenario["above_20_sma"]
                and scenario["momentum_score"] > 0.70
            )
    ...
    async def test_risk_management(self):
        ...
        for pos in test_positions:
            ...
            logger.info(
                f"  {status} {pos['symbol']}: ${pos['value']:,.2f} ({pos_pct:.1f}%) | PnL: {pos['pnl_pct']:+.1f}%"
            )
