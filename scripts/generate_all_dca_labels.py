...
class DCALabelGenerator:
    ...
    def find_historical_setups(self, symbol: str, lookback_days: int) -> List[Dict]:
        ...
        while current_start < end_time:
            ...
            # Fetch chunk
            result = self.supabase.client.table('price_data').select(
    ...
    def simulate_dca_outcome(self, setup: Dict, df: pd.DataFrame, 
                           ml_confidence: float = 0.6) -> Dict:
        """
