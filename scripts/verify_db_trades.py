...
def verify_trades():
    ...
    print("=" * 60)
    print("\nSummary:")
    print(f"- GRT: {'OPEN position (currently trading)' if 'GRT' in symbols and not symbols['GRT']['sells'] else 'Position status unknown'}")
    print(f"- ENJ: {'CLOSED position (completed trade)' if 'ENJ' in symbols and symbols['ENJ']['sells'] else 'Position status unknown'}")
