...
class SimpleAdaptiveGridTester:
    ...
    def test_scenario(self, symbol: str, scenario: str, entry_price: float = 100.0):
        ...
        market_data = {
            ...
            'symbol_volatility': features_df['btc_volatility_7d'].iloc[0] if 'btc_volatility_7d' in features_df.columns else 0.04,
            'symbol_vs_btc_7d': features_df['symbol_vs_btc_7d'].iloc[0] if 'symbol_vs_btc_7d' in features_df.columns else 0.0,
            'market_cap_tier': 'mid'
        }
