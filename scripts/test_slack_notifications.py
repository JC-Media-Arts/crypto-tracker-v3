...
class SlackNotificationTest:
    ...
    async def run_all_tests(self):
        ...
        if self.notifier.enabled:
            ...
            logger.info("1. Create a Slack webhook at: https://api.slack.com/messaging/webhooks")
            logger.info("2. Add to .env: SLACK_WEBHOOK_URL=https://hooks.slack.com/services/...")
