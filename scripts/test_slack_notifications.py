...
async def test_notifications():
    ...
    test_trades_today = [
        {'symbol': 'BTC', 'pnl_usd': 45.00, 'pnl_percent': 2.5, 'strategy': 'swing', 'exit_reason': 'take_profit'},
        {'symbol': 'ETH', 'pnl_usd': -12.00, 'pnl_percent': -1.2, 'strategy': 'dca', 'exit_reason': 'stop_loss'},
        {'symbol': 'SOL', 'pnl_usd': 28.00, 'pnl_percent': 3.8, 'strategy': 'channel', 'exit_reason': 'take_profit'}
    ]
    
    test_open_positions = [
        {'symbol': 'LINK', 'entry_price': 14.50, 'usd_value': 50.0, 'strategy': 'swing', 'entry_time': datetime.now()},
        {'symbol': 'AVAX', 'entry_price': 35.20, 'usd_value': 50.0, 'strategy': 'dca', 'entry_time': datetime.now()},
        {'symbol': 'MATIC', 'entry_price': 0.85, 'usd_value': 50.0, 'strategy': 'channel', 'entry_time': datetime.now()}
    ]
