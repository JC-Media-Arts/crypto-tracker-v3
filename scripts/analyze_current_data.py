...
def main():
    ...
    try:
        ...
        recent = supabase.client.table("ohlc_data")\
            .select("*", count="exact", head=True)\
            .eq("timeframe", "1m")\
    ...
    try:
        ...
        old_15m = supabase.client.table("ohlc_data")\
            .select("*", count="exact", head=True)\
            .eq("timeframe", "15m")\
    ...
    try:
        ...
        old_1h = supabase.client.table("ohlc_data")\
            .select("*", count="exact", head=True)\
            .eq("timeframe", "1h")\
    ...
    try:
        ...
        old_scans = supabase.client.table("scan_history")\
            .select("*", count="exact", head=True)\
