    ...
    for tf in timeframe_list:
        ...
        while end_date > cutoff_dt - timedelta(days=365*10):  # Don't go back more than 10 years
            ...
            try:
                ...
                logger.info(f"  Deleting {tf} from {start_date.date()} to {end_date.date()} (batch size: {current_batch_size} days)")
                ...
                if "timeout" in error_msg.lower():
                    ...
                    if consecutive_failures >= max_retries_per_range:
                        ...
                        if current_batch_size > min_batch_days:
                            ...
                            logger.error(f"  Failed to delete range after {max_retries_per_range} attempts, skipping...")
