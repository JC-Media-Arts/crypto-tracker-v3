...
class HealthChecker:
    ...
    def __init__(self, settings: Settings, data_collector: Any, ml_predictor: Any, paper_trader: Any):
        ...
        while self.running:
            try:
                ...
                if trading_status['daily_pnl'] < -50:
                    await self._send_alert(
                        'P&L Alert',
                        f'Daily P&L: ${trading_status["daily_pnl"]:.2f}'
                    )
    ...
    def get_health_status(self) -> Dict:
        ...
        return {
            ...
            'overall_health': all([
                self.data_flow_healthy,
                self.ml_healthy,
                self.trading_healthy
            ])
        }
