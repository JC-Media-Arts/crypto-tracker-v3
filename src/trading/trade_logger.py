...
class TradeLogger:
    ...
    def open_trade(self,
                   ...
                   ml_confidence: Optional[float] = None) -> Optional[int]:
        """
    ...
    def close_trade(self,
                   ...
                   btc_price: Optional[float] = None) -> bool:
        """
    ...
    def _calculate_prediction_accuracy(self, trade: Dict, exit_price: float, 
                                      hold_time_hours: float, status: str) -> Dict:
    ...
    def get_trade_performance(self, hours: int = 24) -> Dict:
        ...
        try:
            ...
            stats = {
                ...
                'avg_pnl_pct': sum(float(t['pnl_percentage'] or 0) for t in closed_trades) / len(closed_trades) if closed_trades else 0,
