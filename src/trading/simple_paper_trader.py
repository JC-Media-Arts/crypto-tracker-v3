...
class SimplePaperTrader:
    ...
    def __init__(self, initial_balance: float = 10000.0):
        ...
        self.major_coins = ['BTC', 'ETH', 'SOL', 'XRP', 'ADA', 'AVAX', 'DOGE', 'DOT', 'LINK', 'MATIC']
        self.meme_coins = ['SHIB', 'PEPE', 'FLOKI', 'BONK', 'WIF', 'MEME', 'MYRO', 'PONKE', 'POPCAT', 'TRUMP']
    ...
    def get_portfolio_stats(self) -> Dict:
        ...
        avg_loss = sum(t.pnl_usd for t in self.trades if t.pnl_usd < 0) / max(1, (self.total_trades - self.winning_trades))
    ...
    def load_state(self):
        ...
        if self.state_file.exists():
            try:
                ...
                logger.info(f"📂 Loaded paper trading state: Balance ${self.balance:.2f}, {len(self.positions)} positions")
