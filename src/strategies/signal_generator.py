        ...
        return [
            {
                ...
                "detected_at": (
                    s["detected_at"].isoformat() if isinstance(s["detected_at"], datetime) else s["detected_at"]
                ),
                "expires_at": (
                    s["expires_at"].isoformat() if isinstance(s["expires_at"], datetime) else s["expires_at"]
                ),
            }
