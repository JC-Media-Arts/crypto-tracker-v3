...
class ShadowEnhancedRetrainer:
    ...
    def should_retrain(self, strategy: str = "DCA") -> Tuple[bool, Dict]:
        ...
        try:
            ...
            logger.info(f"{strategy} - Real: {real_count}, Shadow: {shadow_count}, "
    ...
    def retrain_with_shadows(self, strategy: str = "DCA") -> Dict:
        ...
        try:
            ...
            logger.info(f"Combined training data: {len(real_data)} real + {len(shadow_data)} shadow "
    ...
    def _count_real_trades(self, strategy: str) -> int:
        ...
        try:
            result = self.supabase.table('trade_logs')\
    ...
    def _count_shadow_trades(self, strategy: str) -> int:
        ...
        try:
            ...
            result = self.supabase.rpc('count_shadow_trades_by_strategy', {
                'p_strategy': strategy
            }).execute()
            ...
            result = self.supabase.table('shadow_outcomes')\
    ...
    def _get_real_training_data(self, strategy: str) -> pd.DataFrame:
        ...
        try:
            ...
            result = self.supabase.table('ml_training_feedback')\
                .select('*')\
                .eq('strategy_name', strategy)\
    ...
    def _get_shadow_training_data(self, strategy: str, real_count: int) -> pd.DataFrame:
        ...
        try:
            ...
            result = self.supabase.table('ml_training_with_shadows')\
                .select('*')\
                .eq('strategy_name', strategy)\
            ...
            if result.data:
                ...
                df['sample_weight'] = df.apply(
                    lambda row: self._calculate_shadow_weight(row),
                    axis=1
                )
    ...
    def _compare_with_current(self, new_model, X_val, y_val, strategy: str) -> Optional[float]:
        ...
        try:
            ...
            logger.info(f"Model comparison - Current AUC: {current_auc:.3f}, "
