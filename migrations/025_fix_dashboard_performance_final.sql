...
-- Note: Removed CONCURRENTLY because Supabase runs in transaction
...
CREATE INDEX IF NOT EXISTS idx_ohlc_recent_30d
ON ohlc_data(symbol, timeframe, timestamp DESC)
WHERE timestamp > CURRENT_DATE - INTERVAL '30 days';

-- 3. Create index for the exact query pattern used by dashboard
CREATE INDEX IF NOT EXISTS idx_ohlc_symbol_batch
...
-- Done! Tables and indexes created successfully
